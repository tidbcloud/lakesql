...
use chrono_tz::Tz;
use lake_client::schema::{DataType, DecimalDataType};
use lake_driver::{params, Client, Connection, DecimalSize, NumberValue, Value};
use std::assert_eq;
...
async fn select_geometry() {
    ...
    // https://github.com/tidbcloud/lakesql/pull/15214
}
