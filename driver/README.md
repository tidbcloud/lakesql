# TiDB Cloud Lake Driver

TiDB Cloud Lake unified SQL client for RestAPI and FlightSQL

[![crates.io](https://img.shields.io/crates/v/lake-driver.svg)](https://crates.io/crates/lake-driver)
![License](https://img.shields.io/crates/l/lake-driver.svg)
...
let dsn = "lake://root:@localhost:8000/default?sslmode=disable".to_string();
...
[TiDB Cloud Lake Types](https://docs.tidbcloud.com/sql/sql-reference/data-types/)

### General Data Types

| TiDB Cloud Lake    | Rust                    |
| ----------- | ----------------------- |
| `BOOLEAN`   | `bool`                  |
| `TINYINT`   | `i8`,`u8`               |
| `SMALLINT`  | `i16`,`u16`             |
