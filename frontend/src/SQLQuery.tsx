          ...
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div className="space-y-4 text-sm text-gray-700">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-600">
                <li><code className="text-xs bg-gray-100 px-1 py-0.5 rounded">async_client</code>: an <code>AsyncLakeClient</code> connected to your DSN.</li>
                <li><code className="text-xs bg-gray-100 px-1 py-0.5 rounded">client</code>: a <code>BlockingLakeClient</code> using the same DSN.</li>
              </ul>
              <p>Sync Example:</p>
