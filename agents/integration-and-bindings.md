...
- For local Python binding test runs, make sure the interpreter that owns `behave` is loading the current `lake_driver` build or install, not a stale site-packages copy.
