...
${LAKESQL} --query='INSERT INTO http_books_02 from @_databend_load file_format=(type=csv);' --data=@cli/tests/data/books.csv

${LAKESQL} --query='SELECT * FROM http_books_02 LIMIT 10;' --output=tsv
