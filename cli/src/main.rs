...
struct Args {
    ...
    #[clap(
        short = 'h',
        long,
        help = "Lake Server host, Default: 127.0.0.1, ignored when --dsn is set"
    )]
    host: Option<String>,
    ...
    #[clap(
        short = 'P',
        long,
        help = "Lake Server port, Default: 8000, ignored when --dsn is set"
    )]
    port: Option<u16>,
