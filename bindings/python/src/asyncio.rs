...
pub struct AsyncLakeClient(lake_driver::Client);

#[pymethods]
impl AsyncLakeClient {
    #[new]
    #[pyo3(signature = (dsn))]
    ...
    pub fn get_conn<'p>(&'p self, py: Python<'p>) -> PyResult<Bound<'p, PyAny>> {
        ...
        future_into_py(py, async move {
            ...
            Ok(AsyncLakeConnection(Arc::new(conn)))
        })
    }
}

#[pyclass(module = "lake_driver")]
pub struct AsyncLakeConnection(Arc<lake_driver::Connection>);

#[pymethods]
impl AsyncLakeConnection {
