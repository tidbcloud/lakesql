...
TiDB Cloud Lake Node.js Client

[![image](https://img.shields.io/npm/v/tidbcloudlake-driver.svg)](https://www.npmjs.com/package/tidbcloudlake-driver)
![License](https://img.shields.io/npm/l/tidbcloudlake-driver.svg)
[![image](https://img.shields.io/npm/types/tidbcloudlake-driver.svg)](https://www.npmjs.com/package/tidbcloudlake-driver)
...
[TiDB Cloud Lake Types](https://docs.tidbcloud.com/)

### General Data Types

| TiDB Cloud Lake | Node.js   |
| --------------- | --------- |
| `BOOLEAN`       | `Boolean` |
| `TINYINT`       | `Number`  |
| `SMALLINT`      | `Number`  |
