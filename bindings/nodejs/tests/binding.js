...
process.env.LAKE_DRIVER_HEARTBEAT_INTERVAL_SECONDS = "1";
process.env.RUST_LOG = "warn,tidbcloudlake_driver=debug,tidbcloudlake_client=debug";

const { Client } = require("../index.js");

const dsn = process.env.TEST_LAKE_DSN
  ? process.env.TEST_LAKE_DSN
  : "lake://root:@localhost:8000/default?sslmode=disable";

Given("A new Lake Driver Client", async function () {
